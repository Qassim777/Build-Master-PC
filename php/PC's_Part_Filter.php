...
<header>
        <a href="Index.html/../.." >  <img class="logo" src="../Image/LOGO.png" alt="BUILDMASTERPC logo" width="20%" height="20%"> </a>
        ...
        <nav>
            <ul class="nav_links">
                <li>
                    <a href="../Html/Contact_Us.php"> <img src="../Image/icons8-support-64.png" alt="Support icon" height="30"  width="30px" > </a>
                </li>
                <li>
                    <a href="./Search.php"> <img src="../Image/icons8-search-50.png" alt="Search icon" height="30px"  width="30px"> </a>
                </li>
                <li>
                <?php if (isLoggedIn()) : ?>
                    <a href="../Html/Cart.php" onclick="checkCartStatus()"> 
...
<body>
    ...
    <div class="container">
        <form action="./PC_parts.php"  method="post">
            <button class="component-container" name="product" value="Motherboard"  type="submit">
        ...
        <form action="./PC_parts.php" method="post">
            <button class="component-container" name="product" value="CPU"  type="submit">    
                <div class="img-container">
       ...
       <form action="./PC_parts.php" method="post">
                <button class="component-container" name="product" value="CPU Fan"  type="submit">    
                <div class="img-container">
        ...
        <form action="./PC_parts.php" method="post">
            <button class="component-container" name="product" value="CPU Cooling"  type="submit">    
                <div class="img-container">
        ...
        <form action="./PC_parts.php" method="post">
            <button class="component-container" name="product" value="GPU"  type="submit">    
                <div class="img-container">
        ...
        <form action="./PC_parts.php" method="post">
            <button class="component-container" name="product" value="RAM"  type="submit">
                <div class="img-container">
        ...
        <form action="./PC_parts.php" method="post">
            <button class="component-container" name="product" value="HDD"  type="submit">
                <div class="img-container">
        ...
        <form action="./PC_parts.php" method="post">
            <button class="component-container" name="product" value="SSD"  type="submit">
                <div class="img-container">
        ...
        <form action="./PC_parts.php" method="post">
            <button class="component-container" name="product" value="M.2"  type="submit">
                <div class="img-container">
        ...
        <form action="./PC_parts.php" method="post">
            <button class="component-container" name="product" value="Power Supply"  type="submit">
        ...
        <form action="./PC_parts.php"  method="post">
                <button class="component-container" name="product" value="case" type="submit">
                    <div class="img-container">
