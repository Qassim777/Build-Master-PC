...
<header>
    ...
    <a href="Index.html/../.."> <img class="logo" src="../Image/LOGO.png" alt="BUILDMASTERPC logo" width="20%"
            height="20%"> </a>
...
try {
    ...
    $query = "SELECT * FROM product WHERE product_type='Accessory'";
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        <div class="pc-container">
            ...
            if (isset($row['picture'])) {
                ...
                echo '<a href="./product_page.php" name="dataInput" onclick="setProdcutNum(' . $row['ProductID'] . ')">';
                echo '<div class="img-continer">';
                echo '<img src="../Html/admin/image/default.jpg" class="pc-img">';
                echo '</div>';
            }
            ?>
            <?php
            ...
            <div>
                ...
                <?php print ("<h4 class='pc-payment'>" . $row['Price'] . "SR</h4>"); ?>
            </div>
