...
<head>
  ...
  <title>BuildMasterPC | User - Search about product</title>
...
<header>
  ...
  <nav>
    <ul class="nav_links">
      <li>
        <a href="#"> <img class="selected" src="../Image/icons8-search-50.png" alt="Search icon" height="30px"
            width="30px"> </a>
      </li>
      <li>
        <?php if (isLoggedIn()): ?>
  ...
  <ul class="footer__nav">
    ...
    <li class="nav__item">
      ...
      <ul class="nav__ul">
        ...
        <li>
          <a href="./PCs.php">Pc Parts</a>
        </li>

        <li>
          <a href="../Html/Accessories/Accessories.html">Accessories</a>
        </li>
      </ul>
    </li>
