...
<body>
    <header>
        <a href="../Index.php"> <img class="logo" src="../Image/LOGO.png" alt="BUILDMASTERPC logo" width="20%"
                height="20%"> </a>
        <nav>
            <ul class="nav_links">
        ...
        <nav>
            <ul class="nav_links">
                ...
                <li>
                    <?php if (isLoggedIn()): ?>
                        <a href="../Html/Cart.php"><img src="../Image/icons8-cart-64.png" alt="Cart icon" height="30px"
                                width="30px"></a>
                    <?php else: ?>
                        <a href="#" data-modal-target="#user-login-modal"><img src="../Image/icons8-cart-64.png"
                                alt="Cart icon" height="30px" width="30px"></a>
                    <?php endif; ?>
                </li>
                <li>
                    <?php if (isLoggedIn()): ?>
                    ...
                    <?php else: ?>
                        <a href="#" data-modal-target="#login-choices-modal"><img src="../Image/login.png" alt="Login icon"
        ...
        <div class="modal" id="login-choices-modal">
            ...
            <div class="modal-body login-choices">
                <div class="pictures" data-modal-target="#admin-login-modal">
                    <a href="#"><img src="../Image/icon-admin.png" alt="admin login" width="150"></a>
                    <div class="description">Admin Login</div>
                </div>
                <div class="pictures" data-modal-target="#user-login-modal">
                    <a href="#"><img src="../Image/user-128.png" alt="user login" width="150"></a>
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                <div class="pc-container">
                    ...
                    if (isset($row['picture'])) {
                        echo '<a href="./product_page.php" name="dataInput" onclick="setProdcutNum(' . $row['ProductID'] . ')">';
