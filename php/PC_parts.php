...
<header>
  ...
  <nav>
    <ul class="nav_links">
      ...
      <li>
        <a href="../Html/PC's_Parts/PC's_Part_Filter.html">Pc Parts</a>
      </li>
      <li>
  ...
  <nav>
    <ul class="nav_links">
      ...
      <li>
        <a href="./Search.php"> <img src="../Image/icons8-search-50.png" alt="Search icon" height="30px" width="30px">
        </a>
      </li>
      <li>
        <?php if (isLoggedIn()): ?>
...
<body>
  ...
  try {
    ...
    $conn = new mysqli('localhost:3307:3307', 'root', '', 'build_master_pc');
          ...
          <form action="./addToCart.php" method="post">
            <?php if (isLoggedIn()): ?>
              <form action="./addToCart.php" method="post">
                ...
                <button class="cart-button" type="submit"><img class="shopping-cart-img" src='../Image/cart.svg'></button>
              </form>
            <?php else: ?>
              <a href="#" data-modal-target="#user-login-modal">
                <img src="../Image/icons8-cart-64.png" alt="Cart icon" height="30px" width="30px">
    ...
    // Handle the exception, maybe redirect the user or display an error message
  }
  ?>
...
<footer class="footer">
  <div class="footer__addr">
    ...
    <address>
      ...
      <a class="footer__btn" href="../Contact_Us.html">Contact Us</a>
    </address>
  </div>
