  ...
  <header>
    ...
    <nav>
      <ul class="nav_links">
        ...
        <li>
          <a href="./Admin_Dashboard_modify1.php"> <img class="selected" src="../../Image/modify.png" alt="modify icon"
              height="30px" width="30px"> </a>
        </li>
        <li>
  ...
  <body>
    ...
    try {
      ...
      if (!empty($searchTerm)) {
        ...
        $query = "SELECT * FROM `product` WHERE `product_type` LIKE '%" . mysqli_real_escape_string($database, $searchTerm) . "%'";
